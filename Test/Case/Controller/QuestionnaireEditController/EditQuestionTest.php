	...
	public function setUp() {
		...
		$this->controller->Session->expects($this->any())
			...
			->will($this->returnValueMap([
				...
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession', true],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_4', true],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_12', true],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_44', true],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_40', true],
		...
		$this->controller->Session->expects($this->any())
			...
			->will($this->returnValueMap([
				...
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession', $this->__getData()],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_4', $this->__getData('questionnaire_4')],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_12', $this->__getData('questionnaire_12')],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_44', $this->__getData('questionnaire_44')],
				['Questionnaires.postQuestionnaireQuestion.' . 'testSession_40', $this->__getData('questionnaire_40')],
