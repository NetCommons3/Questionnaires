	...
	public function dataProviderValidationError() {
		...
		return array(
			...
			array($data, 3, $rangeQuestion, 'answer_value', '2016-11-30',
				__d('questionnaires', 'Please enter the answer between %s and %s.', '2015-01-01', '2015-12-31')),
			...
			array($data, 3, $timeRangeQuestion, 'answer_value', '01:00',
				__d('questionnaires', 'Please enter the answer between %s and %s.', '06:15', '12:30')),
			...
			array($data, 3, $datetmRangeQuestion, 'answer_value', '2015-01-01 01:00',
				__d('questionnaires', 'Please enter the answer between %s and %s.', '2015-07-01 06:15', '2015-12-31 12:30')),
