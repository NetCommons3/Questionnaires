 ...
 */
	public $migration = array(
		...
		'down' => array(
			'drop_field' => array(
				'questionnaire_choices' => array('is_origin', 'is_translation'),
				'questionnaire_pages' => array('is_origin', 'is_translation'),
				'questionnaire_questions' => array('is_origin', 'is_translation'),
				'questionnaires' => array('is_origin', 'is_translation'),
			),
		),
	);
