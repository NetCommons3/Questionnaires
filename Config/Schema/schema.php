...
'),
		...
		'questionnaire_question_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'index'),
		'skip_page_sequence' => array('type' => 'integer', 'null' => false, 'default' => null, 'comment' => 'questionnairesのskip_flagがスキップ有りの時、スキップ先のページ'),
		'created_user' => array('type' => 'integer', 'null' => true, 'default' => null),
		'created' => array('type' => 'datetime', 'null' => true, 'default' => null),
		'modified_user' => array('type' => 'integer', 'null' => true, 'default' => null),
		'modified' => array('type' => 'datetime', 'null' => true, 'default' => null),
	...
	public $questionnaire_entities = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'),
		...
		'period_flag' => array('type' => 'boolean', 'null' => true, 'default' => null, 'comment' => '期間設定フラグ | 0:期間設定なし| 1:期間設定あり'),
...
選択肢分岐機能との兼ね合いを考えなくてはならないため、現時点での機能盛り込みは見送る'),
	...
	public $questionnaire_i18n = array(
		'id' => array('type' => 'integer', 'null' => false, 'default' => null, 'key' => 'primary'),
	...
	public $questionnaire_questions = array(
		...
		'question_type' => array('type' => 'integer', 'null' => true, 'default' => null, 'length' => 4, 'comment' => '質問タイプ | 1:択一選択 | 2:複数選択 | 3:テキスト | 4:テキストエリア | 5:マトリクス（択一） | 6:マトリクス（複数>） | 7:日付・時刻 | 8:リスト
'),
		...
		'skip_flag' => array('type' => 'boolean', 'null' => true, 'default' => '0', 'comment' => 'アンケート回答のスキップ有無  0:スキップ無し  1:スキップ有り'),
