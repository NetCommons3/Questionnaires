    ...
    <div class="modal-body">
        ...
        <div class="tab-body has-feedback" >
            ...
            <table class="table table-bordered">
                <tr>
                    <th><?php echo __d('qestionnaires', 'Status'); ?></th>
                    <th><?php echo __d('qestionnaires', 'Title'); ?></th>
                    <th><?php echo __d('qestionnaires', 'Created'); ?></th>
                    <th><?php echo __d('qestionnaires', 'Modified'); ?></th>
                    <th><?php echo __d('qestionnaires', 'Answer download'); ?></th>
                </tr>
