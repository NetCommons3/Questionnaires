...
<div class="row">
    <div class="col-sm-12">
        <div class="checkbox">
            <label>
                <input type="checkbox" ng-model="question.setDateTimeRange"><?php echo __d('questinnaires', 'set range to answer date and time'); ?>
            </label>
        </div>
    </div>
</div>
...
<div class="row">
    <div ng-show="question.setDateTimeRange">
        <div class="col-sm-5">
            <p class="input-group" ng-show="question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_DATE; ?> || question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_DATE_TIME; ?>">
            ...
            <div ng-model="question.min"  ng-show="question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_TIME; ?> || question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_DATE_TIME; ?>">
        ...
        <div class="col-sm-5">
            ...
            <div ng-model="question.max"  ng-show="question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_TIME; ?> || question.question_type_option == <?php echo QuestionnairesComponent::TYPE_OPTION_DATE_TIME; ?>">
                <timepicker hour-step="1" minute-step="15" ></timepicker>
            </div>
